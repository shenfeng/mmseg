...
public class SimpleMMsegTokenizerBSDicTest {

    Dictionary dic;

    public SimpleMMsegTokenizerBSDicTest() throws IOException {
        URL url = SimpleMMsegTokenizerBSDicTest.class.getClassLoader()
                .getResource("data/words.dic");
        dic = new BSDictionary(new File(url.getFile()));
    }
